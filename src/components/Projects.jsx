import SignLearn from '../assets/signLearn.png'
import Portfolio from '../assets/Portfolio.png'
import StdSys from '../assets/SES.png'
...
export const Projects = ({id}) => {
   return (
    <div className='mb-20'>
        ...
        <div>
            <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center justify-around pb-10">
                <Card 
                    photo = {SignLearn}
                    title = "SignLearn"
                    description= "A gamified e-learning platform for deaf and mute children, built using MERN stack. Features interactive sign-language-based games, real-time progress tracking, and an accessibility-first design to make learning engaging and inclusive."
                    href="https://github.com/nilamkumari11/SignLearn"
                />
                <Card 
                    photo = {Portfolio}
                    title = "My Portfolio Website"
                    description= "A responsive portfolio website built with React, Tailwind CSS, and JavaScript to showcase my skills, projects, and contact information. Features smooth animations, section-based navigation, and a mobile-friendly design."
                    href = "https://github.com/nilamkumari11/Nilam-Portfolio"
                />
                <Card 
                    photo = {StdSys}
                    title = "Student Enrollment System"
                    description= "A web-based student enrollment system built with Java, JSP, Servlets, SQL, and XAMPP. Includes an admin panel for managing student records and individual student logins to view academic progress and also update their own profile."
                    href = "https://github.com/nilamkumari11/StudentEnrollmentSystem"
                />
                <Card 
                    photo = {ToDo}
                    title = "To Do App "
                    description= "A responsive task management application developed using JavaScript, HTML, and CSS. Enables users to efficiently add, edit, delete, and mark tasks as complete with an intuitive interface for seamless task organization."
                    href = "https://github.com/nilamkumari11/ToDoApp"
                />
                <Card 
                    photo = {brick}
...
const Card = ({
    ...
    return (
        <div className='items-center w-97 h-150 bg-gray-700/40 backdrop-blur-sm border border-gray-600 rounded-xl md:hover:scale-101 hover:scale-105 hover:border-cyan-600 ml-2 lg:mb-0 mb-10'>
            ...
            <div className='flex flex-col items-center text-center gap-3'>
                ...
                <p className='text-white text-lg px-8 text-left'>{description}</p>
                <div className='m-4 '>
                    <a
                        href={href}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-2 py-2 bg-transparent border border-cyan-500 text-cyan-500 hover:bg-gray-800 rounded w-full sm:w-48 hover:scale-110 transition-transform duration-200 ease-in-out"
                    >
