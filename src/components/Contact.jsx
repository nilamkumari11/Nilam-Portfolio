...
export const Contact = ({id}) => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_3vrcrvb",     // EmailJS service ID
        "template_15og9o3",    // EmailJS template ID
        form.current,
        "MDtpfhkZW0wc3isYK"      // EmailJS public key
      )
      .then(
        (result) => {
  ...
  return (
    ...
    <div id={id} className="flex flex-col  justify-around items-center min-h-screen rounded-4xl m-20"> 
        <div className="">
            ...
            <div className="w-24 h-0.5 bg-cyan-500 mx-auto mt-2 mb-10">
                                    <svg role="img" 
                                        viewBox="0 0 20 20" 
                                        color="cyan"
            ...
            <div className="text-gray-500 text-center text-lg mx-10">
                <p>"I’m currently learning, building, and growing as a developer. If you have advice, opportunities, or just want to connect, feel free to reach out!</p>
            </div>
        </div>
        <div className="flex items-center">
            
                <div className="bg-gray-600/40 text-white shadow-md shadow-cyan-500 rounded-2xl p-8 border border-cyan-500 sm:w-full sm:max-w-lg w-80">
                ...
                <input
                    ...
                    required
                    className="w-full p-3 border border-cyan-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <input
                    type="email"
                    name="user_email"
                ...
                <button
                    type="submit"
                    className="w-full bg-cyan-600 text-white py-3 rounded-lg hover:bg-blue-700 transition"
                >
                    Send Message
                </button>
                </form>
